package ru.otus.books.mongock.testchangelog;
...
public class DatabaseChangelog {
    ...
    public void insertBooks(BookRepository bookRepo, GenreRepository genreRepo, AuthorRepository authorRepo) {
        ...
        bookRepo.save(new Book("B1", "Hobbit", authorTolkien, genreFantasy)).block();
        bookRepo.save(new Book("B2", "The Lord of the Rings", authorTolkien, genreFantasy )).block();
        bookRepo.save(new Book("B3", "White Fang", authorJackLondon, genreNovel)).block();
    }
